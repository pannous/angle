...
math_operators = ["^", "^^", "**", "*", "/", "//", "+", "-", "%"];
english_operators = list(["power", "to the", "pow", "times", "divided by", "divide by", "plus", "minus", "add", "subtract", "mod", "modulo", "print"]);
true_operators = ((math_operators + english_operators) + logic_operators);
...
modifier_words = (const_words + ["protected", "private", "public", "static", "void", "default", "initial", "mut", "mutable", "variable", "typed"]);
